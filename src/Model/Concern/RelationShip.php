...
use Yng\Helper\Str;
use Yng\Model;
use Yng\Model\Relation;
use Yng\Model\Relation\BelongsTo;
use Yng\Model\Relation\BelongsToMany;
use Yng\Model\Relation\HasMany;
use Yng\Model\Relation\HasManyThrough;
use Yng\Model\Relation\HasOne;
use Yng\Model\Relation\HasOneThrough;
use Yng\Model\Relation\MorphMany;
use Yng\Model\Relation\MorphOne;
use Yng\Model\Relation\MorphTo;
use Yng\Model\Relation\MorphToMany;
use Yng\Model\Relation\OneToOne;
...
trait RelationShip
{
    ...
    protected function isRelationAttr(string $attr)
    {
        ...
        if ((method_exists($this, $relation) && !method_exists('Yng\Model', $relation)) || isset(static::$macro[static::class][$relation])) {
            return $relation;
        }
